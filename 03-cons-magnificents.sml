...
top_anchovy_with_cheese(
	...
	Anchovy(
		...
		Cheese(
		    Anchovy(
			Crust))))));
(* Onion (Cheese (Anchovy (Cheese (Cheese #)))) *)
...
fun subst_anchovy_by_cheese2(Crust)
  ...
  | subst_anchovy_by_cheese2(Onion(x))
    = Onion(subst_anchovy_by_cheese2(Onion(x)))
...
* The third moral:                                                  *
*                                                                   *
* Functions that produce values of a datatype must be the           *
